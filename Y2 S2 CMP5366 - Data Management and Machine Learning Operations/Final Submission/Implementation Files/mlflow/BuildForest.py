...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        rmse_3, mae_3, r2_3 = eval_metrics(test_y, y_pred_rf)
        
        # Output the metrics to the stdout   
        # (this is somewhat equivalent to print)
        sys.stdout.write("  Random Forest Model:\n")
        sys.stdout.write("  RMSE: %s\n" % rmse_3)
        sys.stdout.write("  MAE: %s\n" % mae_3)
        sys.stdout.write("  R2: %s\n\n" % r2_3)
        
        # Log the metrics to mlflow
        mlflow.log_metric("Forest_rmse", rmse_3) # root mean square error
        mlflow.log_metric("Forest_r2", r2_3) # r squared
        mlflow.log_metric("Forest_mae", mae_3) # mean absolute error
        ...
        if tracking_url_type_store != "file":            # Register the model
            ...
            mlflow.sklearn.log_model(rfModel, "model", registered_model_name="Random Forest Micronutrient Model")
        else:
