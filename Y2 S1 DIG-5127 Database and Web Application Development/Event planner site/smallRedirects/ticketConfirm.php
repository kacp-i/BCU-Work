...
<html lang="en">
    <head>
        ...
        <title>Ticket Created Successfuly</title> <!-- Setting the title of the page -->
    ...
    <body>
        ...
        <!-- div to conatin the confirmation message -->
        <div class="content3">
            <div class="whiteBox" id="ticketConfirmBox">
                ...
                <h2 id="tickText">The customer support team will aim to get back to you within the next<br>2 - 5 working days to help resolve this issue <br><br>Thank you for your patience</h2>
